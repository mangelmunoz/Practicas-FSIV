...
cv::Mat fsiv_gw_color_balance(cv::Mat const& in, float p)
{
    ...
    cv::Mat in2;
	 ...
	 //    int intensidad = 0, intensidadpixel = 0, intensidadref;
	 //    float rojo, azul, verde, 

	 //    // pixeles.push_back(in.at<cv::Vec3b>(0,0));
	    
	 //    // ptr=in.at<cv::Vec3b>(0,0);

	 //    // intensidadref = (0.1*ptr[0]+0.6*ptr[1]+0.3*ptr[2]) / 3;
		...
		//    //  			pixeles.push_front(ptr);
		//    //  		}
		    		
		//    //  		else 
		//    //  		{
		//    //  			pixeles.push_back(ptr);
		...
		//     // 	for(int j = 0; j < pixeles.size() - 1; j++)
		//     // 	{
		//     // 		// cv::Vec3b ptr1 =pixeles.at<cv::Vec3b>(j);
		//     // 	}
  ...
  //   	}
  //   	// ptr=in.at<cv::Vec3b>(0,0);
  //   	// vrojo.push_back(in.at<cv::Vec3b>(0,0)[2]);
  //   	// vverde.push_back(in.at<cv::Vec3b>(0,0)[1]);
  //   	// vazul.push_back(in.at<cv::Vec3b>(0,0)[0]);
  ...
  //   // {
	 ...
	 //   //  		if(vrojo[ref] >= in.at<cv::Vec3b>(i,j)[2])
	 //   //  		{
	 //   //  			vrojo.push_front(in.at<cv::Vec3b>(i,j)[2]);
	 //   //  			ref++;
	 //   //  		}
	 //   //  		else
	 //   //  		{
